...
* 入力制御機能：押されているか判定処理
* 引数：XINPUTのボタン情報
* XINPUT＿BUTTON＿DPAD_UP				(0)		//デジタル方向ボタン上
* XINPUT＿BUTTON＿DPAD_DOWN				(1)		//デジタル方向ボタン下
* XINPUT＿BUTTON＿DPAD_LEFT				(2)		//デジタル方向ボタン左
* XINPUT＿BUTTON＿DPAD_RIGHT			(3)		//デジタル方向ボタン右
* XINPUT＿BUTTON＿START					(4)		//STARTボダン
* XINPUT＿BUTTON＿BACK					(5)		//BACKボタン
* XINPUT＿BUTTON＿LEFT_THUMB			(6)		//左スティック押し込み
* XINPUT＿BUTTON＿LEFT_THUMB			(7)		//右スティック押し込み
* XINPUT＿BUTTON＿LEFT_SHOULDER			(8)		//LBボタン
* XINPUT＿BUTTON＿RIGHT_SHOULDER		(9)		//RBボタン
* XINPUT＿BUTTON＿A						(12)	//Aボタン
* XINPUT＿BUTTON＿B						(13)	//Bボタン
* XINPUT＿BUTTON＿X						(14)	//Xボタン
* XINPUT＿BUTTON＿Y						(15)	//Yボタン
